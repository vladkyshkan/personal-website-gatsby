        ...
        return (
          <Layout key={title} dark="true">
            ...
            <CaseBlock>
              ...
              <P>
                Although not all users start their shopping experience from the
                homepage (they can get to specific category or product page
                through search, ads or promotional emails), it is still
                important to show what type of site it is and what products
                customers can find here. MD Fashion homepage has different parts
                such as brands, custom collections, popular categories and
                items, that could inspire users to explore website and find
                clothes or shoes they are looking for.
              </P>
            </CaseBlock>
            <CaseImageWide>
            ...
            <CaseBlock>
              ...
              <div>
                <P>
                  ...
                  scope and navigate within other product categories while all
                  applied filters are displayed as summary at the top of the
                  page.
                </P>
                <P>
                  MD Fashion is a marketplace so it is neccessary to provide
                  options for brands promotion, such as banner ads and seperate
                  landing pages.
                </P>
              </div>
            </CaseBlock>
            ...
            <CaseBlock>
              <H3>Product page</H3>
              <P>
                The product page is where majority of customers make decision on
                whether or not they want to purchase the item. Images from
                multiple angles as well as information regarding material, fit
                and brand help users to better evaluate the product. One of the
                biggest problem during online shopping is to choose size of the
                item correctly, so we provide size guide and matching between
                international and manufacture sizes.
              </P>
            </CaseBlock>
            <CaseImageWide>
            ...
            <CaseBlock>
              ...
              <P>
                ...
                customer hasn't add any items to cart? Then the website displays
                favorites and recommended items instead of empty screen and in
                such a way could increase average order value.
              </P>
            </CaseBlock>
            <CaseImageWide>
            ...
            <CaseBlock>
              <P>
                For the checkout we opted for an accordion-style flow where the
                just-completed step collapses into summary and the new one
                expands. Such a structure divides all fields into logical chunks
                such as "Contact information", "Delivery", "Loyalty" and
                "Payment", thus decreases user's mental workload. Moreover, this
                type of checkout allows customers to review previously typed
            ...
            <CaseBlock>
              <H3>Account</H3>
              <P>
                The largest part of any e-commerce revenue comes from returning
                customers and account service can make their life much easier.
                Here users can save personal data for quick checkout, check
                order history or available bonuses and subscribe to news and
                promotions.
              </P>
            </CaseBlock>
            <CaseImageWide>
            ...
            <CaseBlock>
              ...
              <div>
                <P>
                  ...
                  website and deliver proper shopping experience to the fans of
                  world-known brands in Ukraine.
                </P>
                <H5>50+ screens</H5>
              </div>
            </CaseBlock>
            ...
            <CaseBlock>
              <H3>Credits</H3>
              <P>
                Head of Design: Vlad Kyshkan <br />
            ...
            <CaseNext
              ...
              title="LUN Misto"
              slug="lun"
              description="City comfort map design for the social project"
...
export const query = graphql`
  query {
    ...
    ImageNext: file(
      relativePath: { eq: "images/cases/md-fashion/md-fashion-next.png" }
    ) {
      childImageSharp {
