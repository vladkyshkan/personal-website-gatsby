          ...
          <Layout key={title}>
            ...
            <CaseContent>
              <CaseBlock>
                ...
                <div>
                  <P>
                    ...
                    life in Kyiv. They have created an interactive map where
                    each person could find researches regarding city (such as
                    noise levels, quality of air or queues at the
                    kindergartens), but this solution was difficult to scale.
                  </P>
                  <P bold>
                    Our task was to redesign the city comfort map, visualize
                    data in a convenient way and help people find the best place
                    to live, work and relax in Kyiv. This task was done during
              ...
              <CaseBlockWide gray>
                <Wrapper>
                  ...
                  <div>
                    ...
                    <ul>
                      <li>
                        What do people mean under the word "comfort"? How do
                        they understand whether a place is comfortable or not?
                        What criteria of comfort are important and how are they
                        defined?
                      </li>
                      <li>
                        How to show a lot of heterogeneous information on the
                        map at the same time? The previous solution works well
                        for one or two criteria but turned into a mess if many
              ...
              <CaseBlock>
                ...
                <div>
                  <P>
                    ...
                    to buy or rent an apartment in the nearest future. Such
                    people try to find as much information as possible regarding
                  ...
                  <P>
                    ...
                    understand how people define, prioritize and compare
                    different criteria of comfort.
                  </P>
                  <CaseQuote>
                    <div>
                    ...
                    <div>
                      <P bold>
                        “For me, comfort is a combination of historical and
                        modern buildings. It is a place near the park with
                        water, where you can run, ride a skateboard or a bike.”
                      </P>
                      <H5>— Ivan</H5>
                    </div>
                  </CaseQuote>
                  <CaseQuote>
                    ...
                    <div>
                      <P bold>
                        ...
                        for an apartment near transport interchange and
                        renovated metro station.”
                      </P>
                      <H5>— Valeria</H5>
                    </div>
                  </CaseQuote>
              ...
              <CaseBlockWide gray>
                <Wrapper>
                  ...
                  <P>
                    ...
                    education, etc that make sense to them. When we had
                    confidence in the concepts, we began creating a visual
                    design.
                  </P>
                </Wrapper>
              </CaseBlockWide>
              ...
              <CaseBlock>
                <H3>The solution</H3>
                <P>
                  Each person has his criteria of comfort when choosing a place
                  to live, work or relax. For example, some people want to live
                  as close as possible to the center of the city, while others
                  don't like crowds of people. The initial experience with the
                  comfort map starts with onboarding, where the user can select
                  the most important criteria for him. A quick tutorial
                  following afterward shows the main features of the comfort
                  map.
                </P>
              </CaseBlock>
              <CaseImageWide>
              ...
              <CaseBlockWide dark>
                <Wrapper>
                  ...
                  <P>
                    ...
                    included in the roadmap and will be implemented in the
                    nearest future.
                  </P>
                </Wrapper>
              </CaseBlockWide>
