        ...
        return (
          <Layout key={title}>
            ...
            <CaseBlock>
              ...
              <div>
                <P>
                  Having collected business needs and problems, we wanted to see
                  how users actually interact with Nova Poshta mobile app and
                  what problems they encounter on the way. Luckily for us, Nova
                  Poshta has great customer base and several users happily
                  accepted our offer to take part in the research.
                </P>
                <P>
                  ...
                  feelings customers have. Afterward, we gave them the existing
                  application and asked to go through the specific package
                  creation flow. Although we had some ideas of what problems
                  users might have, observing real users interact with the app
                  was an eye-opening experience and revealed non-obvious
                  friction points.
                </P>
                <CaseQuote>
                  <div>
                  ...
                  <div>
                    <P bold>
                      “I’m not sure what I should do next after I have created a
                      package through the application.”
                    </P>
                    <H5>— Nataliia</H5>
                  </div>
                </CaseQuote>
            ...
            <CaseBlock>
              <H3>The solution</H3>
              <P>
                We have redesigned homescreen of the Nova Poshta app and made
                key actions the most noticable elements of the screen. Moreover,
                the app could indicate the user's location so he shouldn't do
                this manually during package creation flow. There is feed of
                send and received packages on the bottom of the screen so the
                user could easily access them and check their status.
              </P>
            </CaseBlock>
            <CaseImageWide>
            ...
            <CaseBlock>
              <div>
                <P>
                  ...
                  about item he wants to send. All packages shipped by Nova Poshta
                  could be divided into several categories and app shows the most
                  popular ones so the user shouldn't type description of package
                  over and over again.
                </P>
                <P>
                  ...
                  benchmarks (items that everyone has at home) to compare with
                  package.
                </P>
              </div>
            </CaseBlock>
            ...
            <CaseBlock>
              <P>
                ...
                any Nova Poshta department and show client card to operator) and
                nudge them to do secondary actions (find nearest department or
                call courier).
              </P>
            </CaseBlock>
            <CaseImageWide>
            ...
            <CaseBlock>
              <H3>User Tests</H3>
              <P>
                With the digital prototypes on hand, we have conducted the last
                stage of user testing with invited customers, as well as field
                testing. Field tests showed that the new package registration
                flow is indeed intuitive and seamless.
              </P>
            </CaseBlock>
            <CaseImage>
            ...
            <CaseNext
              ...
              title="Noblesse"
              slug="noblesse"
              description="E-commerce website for the luxury watches and jewelry store"
...
export const query = graphql`
  query {
    ...
    ImageNext: file(
      relativePath: { eq: "images/cases/nova-poshta/nova-poshta-next.png" }
    ) {
      childImageSharp {
